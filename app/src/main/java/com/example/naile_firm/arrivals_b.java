...
public class arrivals_b extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arrivals_b);
        rawmatspinner=findViewById(R.id.arrivspinnerb);
        typetxt=findViewById(R.id.arrivtypetxtb);
        quantitytxt=findViewById(R.id.arrivquantitytxtb);
        datetxt=findViewById(R.id.arrivdatetxtb);
        timetxt=findViewById(R.id.arrivtimetxtb);
        idtxt=findViewById(R.id.arrividtxtb);
    ...
    public void timepicker(){
        timetxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(arrivals_b.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    public void  datepicker(){
        ...
        datetxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODO Auto-generated method stub
                new DatePickerDialog(arrivals_b.this, date, myCalendar
    ...
    public void save_raw_mat_data() {
        ...
        myFab = findViewById(R.id.arrivfloatbtnb);
        myFab.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                MySingleton.getInstance(arrivals_b .this).addToRequestQueue(stringRequest);}
