...
public class trans_c extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    String url = "http://192.168.43.78/www/html/Naile_progect/trans_c.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trans_c);
        rawmatspinner=findViewById(R.id.transspinnerc);
        typetxt=findViewById(R.id.transtypetxtc);
        quantitytxt=findViewById(R.id.transquantitytxtc);
        datetxt=findViewById(R.id.transdatetxtc);
        timetxt=findViewById(R.id.transtimetxtc);
        idtxt=findViewById(R.id.transidtxtc);
    ...
    public void timepicker(){
        timetxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(trans_c.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    public void  datepicker(){
        ...
        datetxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODO Auto-generated method stub
                new DatePickerDialog(trans_c.this, date, myCalendar
    ...
    public void save_raw_mat_data() {
        ...
        myFab = findViewById(R.id.transfloatbtnc);
        myFab.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                MySingleton.getInstance(trans_c .this).addToRequestQueue(stringRequest);}
