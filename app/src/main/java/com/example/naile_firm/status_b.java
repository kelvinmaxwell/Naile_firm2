...
public class status_b extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    String url = "http://192.168.43.78/www/html/Naile_progect/no_matchb.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_status_b);
        mdrawerLayout=findViewById(R.id.drawerlayoutstatusb);
        toolbar=findViewById(R.id.toolBar2);
        spinner=findViewById(R.id.spinnerstatusb);
        retrieveJSON();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(obj.optString("status").equals("true")){
                                ...
                                ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(status_b.this,simple_spinner_item, names);
