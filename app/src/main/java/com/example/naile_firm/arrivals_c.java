...
public class arrivals_c extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    String url = "http://192.168.43.78/www/html/Naile_progect/arriv_c.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arrivals_c);
        rawmatspinner=findViewById(R.id.arrivspinnerc);
        typetxt=findViewById(R.id.arrivtypetxtc);
        quantitytxt=findViewById(R.id.arrivquantitytxtc);
    ...
    public void timepicker(){
        timetxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(arrivals_c.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    public void  datepicker(){
        ...
        datetxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODO Auto-generated method stub
                new DatePickerDialog(arrivals_c.this, date, myCalendar
    ...
    public void save_raw_mat_data() {
        ...
        myFab.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                MySingleton.getInstance(arrivals_c .this).addToRequestQueue(stringRequest);}
