...
public class addsupplier extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    String url = "http://192.168.43.78/www/html/Naile_progect/addsuplier.php";
    String url2 = "http://192.168.43.78/www/html/Naile_progect/selectsuplier.php";
    String url3 = "http://192.168.43.78/www/html/Naile_progect/deletesuplier.php";
        ...
        myFab.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (nametxt.getText().toString().equals("")) {
                    Toast.makeText(addsupplier.this,"You did not enter a name", Toast.LENGTH_SHORT).show();
                    ...
                    MySingleton.getInstance(addsupplier .this).addToRequestQueue(stringRequest);}}
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(addsupplier.this,"status saved",Toast.LENGTH_SHORT).show();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(obj.optString("status").equals("true")){
                                ...
                                ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(addsupplier.this,simple_spinner_item, names);
    ...
    private void showSimpleProgressDialog(addsupplier addproducts, String s, String fetching_json, boolean b) {
    }
}
